        ...
        <div className="min-h-[calc(100vh-5rem)] flex items-center py-20">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
            ...
            <div>
              ...
              {/* Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-display font-bold text-primary-foreground leading-tight mb-6 animate-fade-up animation-delay-100">
            ...
            {/* Image Slideshow */}
            <div className="hidden lg:block h-[500px] animate-fade-up animation-delay-200">
              <ImageSlideshow />
            </div>
          </div>
        </div>
